...
${TESTDIR}/NaiveBayessClassifier/test/naiveBayesClassifierTest.o: NaiveBayessClassifier/test/naiveBayesClassifierTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/NaiveBayessClassifier/test/naiveBayesClassifierTest.o NaiveBayessClassifier/test/naiveBayesClassifierTest.cpp
...
${TESTDIR}/NaiveBayessClassifier/test/naiveBayesClassifierTestRunner.o: NaiveBayessClassifier/test/naiveBayesClassifierTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/NaiveBayessClassifier/test
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/NaiveBayessClassifier/test/naiveBayesClassifierTestRunner.o NaiveBayessClassifier/test/naiveBayesClassifierTestRunner.cpp


${TESTDIR}/NgramBuilder/test/ngramBuilderTest.o: NgramBuilder/test/ngramBuilderTest.cpp 
	${MKDIR} -p ${TESTDIR}/NgramBuilder/test
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/NgramBuilder/test/ngramBuilderTest.o NgramBuilder/test/ngramBuilderTest.cpp


${TESTDIR}/NgramBuilder/test/ngramBuilderTestRunner.o: NgramBuilder/test/ngramBuilderTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/NgramBuilder/test
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/NgramBuilder/test/ngramBuilderTestRunner.o NgramBuilder/test/ngramBuilderTestRunner.cpp
