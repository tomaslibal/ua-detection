...
${TESTDIR}/FileInputReader/test/fileInputReaderTest.o: FileInputReader/test/fileInputReaderTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/FileInputReader/test/fileInputReaderTest.o FileInputReader/test/fileInputReaderTest.cpp
...
${TESTDIR}/UATokenizer/test/uaTokenizerTest.o: UATokenizer/test/uaTokenizerTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/UATokenizer/test/uaTokenizerTest.o UATokenizer/test/uaTokenizerTest.cpp


${TESTDIR}/UATokenizer/test/uaTokenizerTestRunner.o: UATokenizer/test/uaTokenizerTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/UATokenizer/test
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/UATokenizer/test/uaTokenizerTestRunner.o UATokenizer/test/uaTokenizerTestRunner.cpp
...
${OBJECTDIR}/FileInputReader/src/FileInputReader_nomain.o: ${OBJECTDIR}/FileInputReader/src/FileInputReader.o FileInputReader/src/FileInputReader.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileInputReader/src/FileInputReader_nomain.o FileInputReader/src/FileInputReader.cpp;\
	else  \
...
${OBJECTDIR}/NaiveBayessClassifier/src/NaiveBayessClassifier_nomain.o: ${OBJECTDIR}/NaiveBayessClassifier/src/NaiveBayessClassifier.o NaiveBayessClassifier/src/NaiveBayessClassifier.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NaiveBayessClassifier/src/NaiveBayessClassifier_nomain.o NaiveBayessClassifier/src/NaiveBayessClassifier.cpp;\
	else  \
...
${OBJECTDIR}/NgramBuilder/src/NgramBuilder_nomain.o: ${OBJECTDIR}/NgramBuilder/src/NgramBuilder.o NgramBuilder/src/NgramBuilder.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NgramBuilder/src/NgramBuilder_nomain.o NgramBuilder/src/NgramBuilder.cpp;\
	else  \
...
${OBJECTDIR}/UATokenizer/src/UATokenizer_nomain.o: ${OBJECTDIR}/UATokenizer/src/UATokenizer.o UATokenizer/src/UATokenizer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UATokenizer/src/UATokenizer_nomain.o UATokenizer/src/UATokenizer.cpp;\
	else  \
...
${OBJECTDIR}/common/src/uadet2_nomain.o: ${OBJECTDIR}/common/src/uadet2.o common/src/uadet2.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/src/uadet2_nomain.o common/src/uadet2.cpp;\
	else  \
